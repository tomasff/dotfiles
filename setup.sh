...
sudo pacman -S noto-fonts-emoji flameshot unzip alacritty zathura-pdf-mupdf zathura discord python vim ttf-jetbrains-mono ttf-font-awesome gucharmap rofi
